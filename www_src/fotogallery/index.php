    ...
    <div class="row">
        ...
        <div class="embed-responsive embed-responsive-16by9">
            <div style='position: relative; padding-bottom: 51%; height: 0; overflow: hidden;'>
                <iframe id='iframe'
                        src='http://flickrit.com/slideshowholder.php?height=50&size=big&setId=72157650778006061&click=true&thumbnails=0&transition=0&layoutType=responsive&sort=0' 
