...
$lang = array_merge($lang, array(
	...
	'SITE_HOME_URL_EXPLAIN'			=> 'Se specificato, un link a questo URL sarà anteposto nella barra di navigazione della Board e il logo della Board punterà a questo URL invece che all’Indice del Forum. È richiesto un URL assoluto, ad esempio <samp>http://www.phpbb.com</samp>.',
...
$lang = array_merge($lang, array(
	...
	'CONTACT_US_ENABLE_EXPLAIN'		=> 'Questa pagina consente agli utenti di inviare email all’amministratore della Board',
...
$lang = array_merge($lang, array(
	...
	'AUTH_PROVIDER_OAUTH_EXPLAIN'				=> 'Ogni provider OAuth richiede una chiave segreta univoca allo scopo di autenticarsi con il server esterno. Questa deve essere fornita dal servizio OAuth quando registri il tuo sito web e ti deve essere fornita esattamente dal provider.<br />Qualsiasi servizio che non abbia la chiave segreta immessa qui non sarà fruibile dagli utenti del Forum. L’utente può comunque registrarsi ed effettuare il login utilizzando il plug-in di autenticazione DB.',
...
$lang = array_merge($lang, array(
	...
	'USE_SYSTEM_CRON_EXPLAIN'	=> 'Quando disattivato, phpBB provvederà ad avviare esecuzioni pianificate automaticamente. Quando disattivato, phpBB non attuerà nessuna esecuzione periodica; un amministratore di sistema dovrà organizzare il file <code>bin/phpbbcli.php cron:run</code> per richiamarli dal cron di sistema ad intervalli regolari (ad esempio ogni 5 minuti).',
));
...
$lang = array_merge($lang, array(
	...
	'CONTACT_EMAIL'					=> 'Contatta indirizzo email',
