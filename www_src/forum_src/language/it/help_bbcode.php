...
$help = array(
    ...
    array(
        ...
        1 => 'Certo che puoi, ad esempio per attirare l’attenzione di qualcuno puoi scrivere:<br /><br /><strong>[size=200][color=red][b]</strong>Guardami!<strong>[/b][/color][/size]</strong><br /><br />questo genera <span style="color:red;font-size:200%;"><strong>Guardami!</strong></span><br /><br />Non ti consigliamo comunque di esagerare e scrivere molto testo in questo modo. Ricordati inoltre che è compito tuo assicurarti che i tag siano chiusi correttamente. Ad esempio, quello che segue non è corretto:<br /><br /><strong>[b][u]</strong>Questo è sbagliato<strong>[/b][/u]</strong>'
    ),
    array(
        0 => '--',
    ...
    array(
        ...
        1 => 'Il BBCode del phpBB3 incorpora un tag per l’inclusione di immagini nei tuoi messaggi. Ci sono due cose importanti da ricordare nell’usare questo tag: a molti utenti non piacciono molte immagini nei messaggi e in secondo luogo l’immagine deve essere già disponibile su internet (non può esistere solo sul tuo computer per esempio, a meno che tu non abbia un webserver!). Per mostrare delle immagini devi inserire l’URL che rimanda all’immagine con il tag <strong>[img][/img]</strong>. Per esempio:<br /><br /><strong>[img]</strong>http://www.phpbb.com/theme/images/logos/blue/160x52.png<strong>[/img]</strong><br /><br />Puoi inserire un’immagine nel tag <strong>[url][/url]</strong> se vuoi, es.<br /><br /><strong>[url=http://www.google.com/][img]</strong>http://www.phpbb.com/theme/images/logos/blue/160x52.png<strong>[/img][/url]</strong><br /><br />genera:<br /><br /><a href="http://www.phpbb.com/"><img src="http://www.phpbb.com/theme/images/logos/blue/160x52.png" alt="" /></a>'
    ),
    array(
