...
$lang = array_merge($lang, array(
	...
	'CONVERT_COMPLETE_EXPLAIN'	=> 'Hai convertito correttamente la tua Board a phpBB 3.1. Puoi effettuare il login e <a href="../">accedere alla tua Board</a>. Assicurati che le impostazioni siano state trasferite correttamente prima di cancellare la cartella d’installazione. Ricorda che l’aiuto sull’uso di phpBB è disponibile OnLine con la <a href="https://www.phpbb.com/support/documentation/3.0/">Documentazione</a> ed il <a href="https://www.phpbb.com/community/viewforum.php?f=46">forum di supporto</a> (in inglese) o <a href="http://www.phpbbitalia.net/forum/viewforum.php?f=205">forum di supporto</a> (in italiano).',
	...
	'DL_CONFIG_EXPLAIN'			=> 'È possibile scaricare il file completo config.php sul tuo PC. Dovrai poi caricare il file manualmente, sostituendo qualsiasi file config.php esistente nella cartella principale di phpBB 3.1. Ricorda di caricare il file in formato ASCII (consulta la documentazione per l’applicazione FTP se sei incerto su come fare). Quando avrai caricato il file config.php, clicca su “Fatto” per passare allo stadio successivo.',
	'DL_DOWNLOAD'				=> 'Scarica',
	'DONE'						=> 'Fatto',
	...
	'INST_ERR_EMAIL_MISMATCH'		=> 'Gli indirizzi email che hai inserito non coincidono.',
	...
	'PHP_JSON_SUPPORT_EXPLAIN'			=> '<strong>Richiesto</strong> - Per un corretto funzionamento del phpBB, l’estensione PHP JSON deve essere valida.',
	...
	'PHP_SAFE_MODE'						=> 'Modalità provvisoria',
	'PHP_SETTINGS'						=> 'Versione e impostazioni PHP',
	'PHP_SETTINGS_EXPLAIN'				=> '<strong>Necessario</strong> - Si deve utilizzare per lo meno la versione 5.3.3 di PHP per poter installare phpBB. Se si esegue in <var>modalità provvisoria</var> verrà eseguita tale modalità . Questo imporrà limitazioni sulla gestione remota e su funzioni simili.',
	'PHP_URL_FOPEN_SUPPORT'				=> 'Impostazione PHP <var>allow_url_fopen</var> abilitata',
	'PHP_URL_FOPEN_SUPPORT_EXPLAIN'		=> '<strong>Facoltativo</strong> - Questa impostazione è facoltativa, comunque alcune funzioni di phpBB, come il caricamento degli avatar da altri siti, non funzioneranno correttamente senza di essa.',
	'PHP_VERSION_REQD'					=> 'Versione PHP >= 5.3.3',
	...
	'SELECT_FORUM_GA'					=> 'In phpBB 3.1 gli Annunci globali sono collegati ai forum. Seleziona un forum per i tuoi attuali Annunci globali (possono essere spostati successivamente):',
	...
	'STAGE_CREATE_TABLE_EXPLAIN'		=> 'Le tabelle presenti nel database utilizzate da phpBB 3.1 sono state create e popolate con qualche dato iniziale. Procedi alla schermata successiva per completare l’installazione di phpBB.',
	...
	'SUPPORT_BODY'						=> 'Supporto completo viene fornito per la versione più recente di phpBB3 su phpBB.com (in Inglese) e su phpBBItalia.net (in Italiano). Questo include problemi relativi a:</p><ul><li>installazione</li><li>configurazione</li><li>questioni tecniche</li><li>possibili bug nel software</li><li>aggiornamento da versioni Release Candidate (RC) all’ultima versione stabile</li><li>conversione da phpBB 2.0.x a phpBB3</li><li>conversione da altri software per forum a phpBB3 (vedere in particolare i <a href="https://www.phpbb.com/community/viewforum.php?f=486">Convertitori per Forum</a>, in inglese)</li></ul><p>Invitiamo gli utenti che utilizzano ancora versioni beta di phpBB3 a sostituire la loro installazione con una nuova copia della versione più recente.</p><h2>Estensioni / Stili</h2><p>Per questioni relative alle Estensioni, consultate gli appropriati forum su <a href="http://www.phpbbitalia.net/forum/viewforum.php?f=207">phpBBItalia.net</a> o <a href="https://www.phpbb.com/community/viewforum.php?f=451">phpBB.com</a>.<br />Analogamente per gli stili, template e temi, consultate i relativi forum su <a href="http://www.phpbbitalia.net/forum/viewforum.php?f=209">phpBBItalia.net</a> o <a href="https://www.phpbb.com/community/viewforum.php?f=471">phpBB.com</a>.<br /><br />Se le domande riguardano una specifica estensione o uno specifico stile, scrivi direttamente nell’argomento dedicato a quella estensione o a quello stile su phpBB.com o phpBBItalia.net.</p><h2>Come ottenere supporto su phpBBItalia.net</h2><p><a href="http://www.phpbbitalia.net/forum/viewforum.php?f=36">Guide e FAQ su phpBB3</a><br /><a href="http://www.phpbbitalia.net/forum/viewforum.php?f=205">Forum con informazioni e supporto</a>.</p><h2>Come ottenere supporto su phpBB.com (in Inglese)</h2><p><a href="https://www.phpbb.com/community/viewtopic.php?f=14&amp;t=571070">Risorse e riferimenti</a><br /><a href="https://www.phpbb.com/support/">Sezione di supporto</a><br /><a href="https://www.phpbb.com/support/documentation/3.1/quickstart/">Quick Start Guide</a><br /><br />Per assicurarti di essere aggiornato sulle ultime novità e release, puoi sottoscrivere la <a href="https://www.phpbb.com/support/">mailing list di phpBB.com</a>.<br /><br />',
...
// Updater
$lang = array_merge($lang, array(
	'ALL_FILES_UP_TO_DATE'		=> 'Tutti i file sono aggiornati all’ultima versione di phpBB.',
	...
	'DATABASE_UPDATE_COMPLETE'			=> 'L’aggiornamento del database è stato completato!',
	'DATABASE_UPDATE_CONTINUE'			=> 'Continua aggiornamento database',
	...
	'DATABASE_UPDATE_NOT_COMPLETED'		=> 'L’aggiornamento del database non è stato completato.',
	...
	'ERROR'			=> 'Errore',
	'EVERYTHING_UP_TO_DATE'		=> ' Tutti i file sono aggiornati all’ultima versione di phpBB. Adesso devi <a href="%1$s">effettuare il login</a> e controllare se tutto funziona correttamente. Non dimenticare di cancellare, rinominare oppure spostare la cartella "install"! Ti saremmo grati se volessi inviarci informazioni aggiornate su server e configurazioni della Board dal modulo <a href="%2$s">Invia statistiche</a> nel tuo Pannello di Controllo Amministratore (PCA).',
	...
	'FILES_DELETED_EXPLAIN'			=> 'I seguenti file non esistono nella nuova versione. Questi file saranno eliminati dalla vostra installazione.',
	...
	'SHOW_DIFF_DELETED'			=> 'Visualizza il contenuto del file',
	...
	'UPDATE_INSTRUCTIONS'			=> '
		...
		<p>Leggi l’annuncio di rilascio dell’ultima versione prima di continuare il processo di aggiornamento; può contenere informazioni utili. È inoltre presente il collegamento al download completo ed allo storico dei cambiamenti.</p>
		<br />
		...
		<p>Una volta inviati i file, la tua Board risulterà OffLine per gli utenti normali a causa della cartella di installazione che hai appena caricato.<br /><br />
	...
	'UPDATE_FILE_SUCCESS'			=> 'File aggiornati con successo.',
