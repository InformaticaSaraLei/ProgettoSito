            ...
            if ($_log_count) {
                for ($_log_i = 0; $_log_i < $_log_count; ++$_log_i) {
                    ...
                    <td>
                        ...
                        <?php if ($_log_val['DATA']) { ?><br/>&#187; <span class="gensmall">
                            [ <?php echo $_log_val['DATA']; ?> ]</span><?php } ?>
    ...
    if ($this->_rootref['S_CLEARLOGS']) { ?>
        ...
        <fieldset class="quick">
            ...
            <p class="small"><a href="#"
                                onclick="marklist('list', 'mark', true);"><?php echo((isset($this->_rootref['L_MARK_ALL'])) ? $this->_rootref['L_MARK_ALL'] : ((isset($user->lang['MARK_ALL'])) ? $user->lang['MARK_ALL'] : '{ MARK_ALL }')); ?></a> &bull;
                <a href="#"
                   onclick="marklist('list', 'mark', false);"><?php echo((isset($this->_rootref['L_UNMARK_ALL'])) ? $this->_rootref['L_UNMARK_ALL'] : ((isset($user->lang['UNMARK_ALL'])) ? $user->lang['UNMARK_ALL'] : '{ UNMARK_ALL }')); ?></a>
            </p>
        </fieldset>
    <?php } ?>
