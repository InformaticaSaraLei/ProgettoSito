...
$this->_tpl_include('overall_header.html'); ?>
    ...
    <form id="inactive" method="post"
        ...
        <table cellspacing="1">
            ...
            if ($_inactive_count) {
                for ($_inactive_i = 0; $_inactive_i < $_inactive_count; ++$_inactive_i) {
                    ...
                    <td>&nbsp;<input type="checkbox" class="radio" name="mark[]"
                                     value="<?php echo $_inactive_val['USER_ID']; ?>"/>&nbsp;</td>
                    </tr>
                <?php }
            } else { ?>
        ...
        <fieldset class="display-options">
            <?php echo((isset($this->_rootref['L_DISPLAY_LOG'])) ? $this->_rootref['L_DISPLAY_LOG'] : ((isset($user->lang['DISPLAY_LOG'])) ? $user->lang['DISPLAY_LOG'] : '{ DISPLAY_LOG }')); ?>
            : &nbsp;<?php echo (isset($this->_rootref['S_LIMIT_DAYS'])) ? $this->_rootref['S_LIMIT_DAYS'] : ''; ?>
            &nbsp;<?php echo((isset($this->_rootref['L_SORT_BY'])) ? $this->_rootref['L_SORT_BY'] : ((isset($user->lang['SORT_BY'])) ? $user->lang['SORT_BY'] : '{ SORT_BY }')); ?>
            : <?php echo (isset($this->_rootref['S_SORT_KEY'])) ? $this->_rootref['S_SORT_KEY'] : ''; ?> <?php echo (isset($this->_rootref['S_SORT_DIR'])) ? $this->_rootref['S_SORT_DIR'] : '';
            if ($this->_rootref['PAGINATION']) { ?>&nbsp;Users per page: <input class="inputbox autowidth" type="text"
                                                                                name="users_per_page"
                                                                                id="users_per_page" size="3"
                                                                                value="<?php echo (isset($this->_rootref['USERS_PER_PAGE'])) ? $this->_rootref['USERS_PER_PAGE'] : ''; ?>" /><?php } ?>
        ...
        <fieldset class="quick">
            <select
                name="action"><?php echo (isset($this->_rootref['S_INACTIVE_OPTIONS'])) ? $this->_rootref['S_INACTIVE_OPTIONS'] : ''; ?></select>
            ...
            <p class="small"><a href="#"
                                onclick="marklist('inactive', 'mark', true); return false;"><?php echo((isset($this->_rootref['L_MARK_ALL'])) ? $this->_rootref['L_MARK_ALL'] : ((isset($user->lang['MARK_ALL'])) ? $user->lang['MARK_ALL'] : '{ MARK_ALL }')); ?></a> &bull;
                <a href="#"
                   onclick="marklist('inactive', 'mark', false); return false;"><?php echo((isset($this->_rootref['L_UNMARK_ALL'])) ? $this->_rootref['L_UNMARK_ALL'] : ((isset($user->lang['UNMARK_ALL'])) ? $user->lang['UNMARK_ALL'] : '{ UNMARK_ALL }')); ?></a>
            </p>
