...
<?php } ?>
    ...
    <form id="acp_board" method="post"
        ...
        <fieldset>
            ...
            if ($this->_rootref['S_AUTH']) {
                $_auth_tpl_count = (isset($this->_tpldata['auth_tpl'])) ? sizeof($this->_tpldata['auth_tpl']) : 0;
                if ($_auth_tpl_count) {
                    for ($_auth_tpl_i = 0; $_auth_tpl_i < $_auth_tpl_count; ++$_auth_tpl_i) {
                        $_auth_tpl_val = &$this->_tpldata['auth_tpl'][$_auth_tpl_i]; ?>
