                            ...
                            <dl>
                                <dt>
                                    <a href="<?php echo $_draftrow_val['U_INSERT']; ?>"
                                       title="<?php echo((isset($this->_rootref['L_LOAD_DRAFT'])) ? $this->_rootref['L_LOAD_DRAFT'] : ((isset($user->lang['LOAD_DRAFT'])) ? $user->lang['LOAD_DRAFT'] : '{ LOAD_DRAFT }')); ?>"
                                       class="topictitle"><?php echo $_draftrow_val['DRAFT_SUBJECT']; ?></a><br/>
                                    <?php if (!$this->_rootref['S_PRIVMSGS']) {
                                        if ($_draftrow_val['S_LINK_TOPIC']) {
