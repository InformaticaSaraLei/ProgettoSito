...
$this->_tpl_include('overall_header.html'); ?>
    ...
    <form method="post"
          action="<?php echo (isset($this->_rootref['S_PROFILE_ACTION'])) ? $this->_rootref['S_PROFILE_ACTION'] : ''; ?>"
          id="viewprofile">
        <div class="panel bg1<?php if ($this->_rootref['S_ONLINE']) { ?> online<?php } ?>">
            <div class="inner"><span class="corners-top"><span></span></span>
                ...
                <?php if ($this->_rootref['AVATAR_IMG']) { ?>
                    ...
                    <dl class="left-box">
                        ...
                        <?php if ($this->_rootref['RANK_TITLE']) { ?>
                            <dd style="text-align: center;"><?php echo (isset($this->_rootref['RANK_TITLE'])) ? $this->_rootref['RANK_TITLE'] : ''; ?></dd><?php }
                        if ($this->_rootref['RANK_IMG']) { ?>
                            <dd style="text-align: center;"><?php echo (isset($this->_rootref['RANK_IMG'])) ? $this->_rootref['RANK_IMG'] : ''; ?></dd><?php } ?>
                ...
                <dl class="left-box details" style="width: 80%;">
                    <dt><?php echo((isset($this->_rootref['L_USERNAME'])) ? $this->_rootref['L_USERNAME'] : ((isset($user->lang['USERNAME'])) ? $user->lang['USERNAME'] : '{ USERNAME }')); ?>
                        :
                    </dt>
                    <dd>
                        <?php if ($this->_rootref['USER_COLOR']) { ?><span
                            style="color: <?php echo (isset($this->_rootref['USER_COLOR'])) ? $this->_rootref['USER_COLOR'] : ''; ?>; font-weight: bold;"><?php } else { ?>
                            <span><?php }
                                echo (isset($this->_rootref['USERNAME'])) ? $this->_rootref['USERNAME'] : ''; ?></span>
                            <?php if ($this->_rootref['U_USER_ADMIN']) { ?> [ <a
                                href="<?php echo (isset($this->_rootref['U_USER_ADMIN'])) ? $this->_rootref['U_USER_ADMIN'] : ''; ?>"><?php echo((isset($this->_rootref['L_USER_ADMIN'])) ? $this->_rootref['L_USER_ADMIN'] : ((isset($user->lang['USER_ADMIN'])) ? $user->lang['USER_ADMIN'] : '{ USER_ADMIN }')); ?></a> ]<?php }
                            if ($this->_rootref['U_USER_BAN']) { ?> [ <a
                                href="<?php echo (isset($this->_rootref['U_USER_BAN'])) ? $this->_rootref['U_USER_BAN'] : ''; ?>"><?php echo((isset($this->_rootref['L_USER_BAN'])) ? $this->_rootref['L_USER_BAN'] : ((isset($user->lang['USER_BAN'])) ? $user->lang['USER_BAN'] : '{ USER_BAN }')); ?></a> ]<?php }
                            if ($this->_rootref['U_SWITCH_PERMISSIONS']) { ?> [ <a
                                href="<?php echo (isset($this->_rootref['U_SWITCH_PERMISSIONS'])) ? $this->_rootref['U_SWITCH_PERMISSIONS'] : ''; ?>"><?php echo((isset($this->_rootref['L_USE_PERMISSIONS'])) ? $this->_rootref['L_USE_PERMISSIONS'] : ((isset($user->lang['USE_PERMISSIONS'])) ? $user->lang['USE_PERMISSIONS'] : '{ USE_PERMISSIONS }')); ?></a> ]<?php } ?>
                    ...
                    if ($this->_rootref['S_GROUP_OPTIONS']) { ?>
                        ...
                        <input type="submit" name="submit"
                               ...
                               class="button2"/></dd><?php }
                    $_custom_fields_count = (isset($this->_tpldata['custom_fields'])) ? sizeof($this->_tpldata['custom_fields']) : 0;
                    if ($_custom_fields_count) {
                        for ($_custom_fields_i = 0; $_custom_fields_i < $_custom_fields_count; ++$_custom_fields_i) {
                            ...
                            <dd><?php echo $_custom_fields_val['PROFILE_FIELD_VALUE']; ?></dd><?php }
                    }
                    if ($this->_rootref['S_USER_LOGGED_IN'] && $this->_rootref['S_ZEBRA']) {
                        if ($this->_rootref['U_REMOVE_FRIEND']) { ?>

                            <dt>&nbsp;</dt>
                            <dd>
                                <a href="<?php echo (isset($this->_rootref['U_REMOVE_FRIEND'])) ? $this->_rootref['U_REMOVE_FRIEND'] : ''; ?>"><strong><?php echo((isset($this->_rootref['L_REMOVE_FRIEND'])) ? $this->_rootref['L_REMOVE_FRIEND'] : ((isset($user->lang['REMOVE_FRIEND'])) ? $user->lang['REMOVE_FRIEND'] : '{ REMOVE_FRIEND }')); ?></strong></a>
                            </dd>
                        <?php } else if ($this->_rootref['U_REMOVE_FOE']) { ?>

                            <dt>&nbsp;</dt>
                            <dd>
                                <a href="<?php echo (isset($this->_rootref['U_REMOVE_FOE'])) ? $this->_rootref['U_REMOVE_FOE'] : ''; ?>"><strong><?php echo((isset($this->_rootref['L_REMOVE_FOE'])) ? $this->_rootref['L_REMOVE_FOE'] : ((isset($user->lang['REMOVE_FOE'])) ? $user->lang['REMOVE_FOE'] : '{ REMOVE_FOE }')); ?></strong></a>
                            </dd>
                        <?php } else {
                            if ($this->_rootref['U_ADD_FRIEND']) { ?>

                                <dt>&nbsp;</dt>
                                <dd>
                                    <a href="<?php echo (isset($this->_rootref['U_ADD_FRIEND'])) ? $this->_rootref['U_ADD_FRIEND'] : ''; ?>"><strong><?php echo((isset($this->_rootref['L_ADD_FRIEND'])) ? $this->_rootref['L_ADD_FRIEND'] : ((isset($user->lang['ADD_FRIEND'])) ? $user->lang['ADD_FRIEND'] : '{ ADD_FRIEND }')); ?></strong></a>
                                </dd>
                            <?php }
                            if ($this->_rootref['U_ADD_FOE']) { ?>

                                <dt>&nbsp;</dt>
                                <dd>
                                    <a href="<?php echo (isset($this->_rootref['U_ADD_FOE'])) ? $this->_rootref['U_ADD_FOE'] : ''; ?>"><strong><?php echo((isset($this->_rootref['L_ADD_FOE'])) ? $this->_rootref['L_ADD_FOE'] : ((isset($user->lang['ADD_FOE'])) ? $user->lang['ADD_FOE'] : '{ ADD_FOE }')); ?></strong></a>
                                </dd>
                            <?php }
                        }
                    } ?>
            ...
            <div class="inner"><span class="corners-top"><span></span></span>
                ...
                <div class="column1">
                    ...
                    <dl class="details">
                        ...
                        if ($this->_rootref['U_MSN'] || $this->_rootref['USER_MSN']) { ?>
                            ...
                            <dd><?php if ($this->_rootref['U_MSN']) { ?><a
                                ...
                                echo (isset($this->_rootref['USER_MSN'])) ? $this->_rootref['USER_MSN'] : '';
                            } ?></dd><?php }
                        if ($this->_rootref['U_YIM'] || $this->_rootref['USER_YIM']) { ?>
                            ...
                            <dd><?php if ($this->_rootref['U_YIM']) { ?><a
                                ...
                                echo (isset($this->_rootref['USER_YIM'])) ? $this->_rootref['USER_YIM'] : '';
                            } ?></dd><?php }
                        if ($this->_rootref['U_AIM'] || $this->_rootref['USER_AIM']) { ?>
                            ...
                            <dd><?php if ($this->_rootref['U_AIM']) { ?><a
                                ...
                                echo (isset($this->_rootref['USER_AIM'])) ? $this->_rootref['USER_AIM'] : '';
                            } ?></dd><?php }
                        if ($this->_rootref['U_ICQ'] || $this->_rootref['USER_ICQ']) { ?>
                            ...
                            <dd><?php if ($this->_rootref['U_ICQ']) { ?><a
                                ...
                                echo (isset($this->_rootref['USER_ICQ'])) ? $this->_rootref['USER_ICQ'] : '';
                            } ?></dd><?php }
                    ...
                    <dd><?php echo (isset($this->_rootref['USER_JABBER'])) ? $this->_rootref['USER_JABBER'] : ''; ?></dd>
                        ...
                        <dd><?php echo (isset($this->_rootref['PROFILE_FIELD1_VALUE'])) ? $this->_rootref['PROFILE_FIELD1_VALUE'] : ''; ?></dd>
                    <?php } ?>
                ...
                <div class="column2">
                    ...
                    <dl class="details">
                        <dt><?php echo((isset($this->_rootref['L_JOINED'])) ? $this->_rootref['L_JOINED'] : ((isset($user->lang['JOINED'])) ? $user->lang['JOINED'] : '{ JOINED }')); ?>
                            :
                        </dt>
                        <dd><?php echo (isset($this->_rootref['JOINED'])) ? $this->_rootref['JOINED'] : ''; ?></dd>
                        <dt><?php echo((isset($this->_rootref['L_VISITED'])) ? $this->_rootref['L_VISITED'] : ((isset($user->lang['VISITED'])) ? $user->lang['VISITED'] : '{ VISITED }')); ?>
                            :
                        </dt>
                        <dd><?php echo (isset($this->_rootref['VISITED'])) ? $this->_rootref['VISITED'] : ''; ?></dd>
                        <?php if ($this->_rootref['S_WARNINGS']) { ?>

                            <dt><?php echo((isset($this->_rootref['L_WARNINGS'])) ? $this->_rootref['L_WARNINGS'] : ((isset($user->lang['WARNINGS'])) ? $user->lang['WARNINGS'] : '{ WARNINGS }')); ?>
                                :
                            </dt>
                            <dd>
                                <strong><?php echo (isset($this->_rootref['WARNINGS'])) ? $this->_rootref['WARNINGS'] : ''; ?></strong><?php if ($this->_rootref['U_NOTES'] || $this->_rootref['U_WARN']) { ?> [ <?php if ($this->_rootref['U_NOTES']) { ?>
                                    <a
                                    href="<?php echo (isset($this->_rootref['U_NOTES'])) ? $this->_rootref['U_NOTES'] : ''; ?>"><?php echo((isset($this->_rootref['L_VIEW_NOTES'])) ? $this->_rootref['L_VIEW_NOTES'] : ((isset($user->lang['VIEW_NOTES'])) ? $user->lang['VIEW_NOTES'] : '{ VIEW_NOTES }')); ?></a><?php }
                                    if ($this->_rootref['U_WARN']) {
                                        if ($this->_rootref['U_NOTES']) { ?> | <?php } ?><a
                                        href="<?php echo (isset($this->_rootref['U_WARN'])) ? $this->_rootref['U_WARN'] : ''; ?>"><?php echo((isset($this->_rootref['L_WARN_USER'])) ? $this->_rootref['L_WARN_USER'] : ((isset($user->lang['WARN_USER'])) ? $user->lang['WARN_USER'] : '{ WARN_USER }')); ?></a><?php } ?> ]<?php } ?>
                            </dd>
                        <?php } ?>

                        <dt><?php echo((isset($this->_rootref['L_TOTAL_POSTS'])) ? $this->_rootref['L_TOTAL_POSTS'] : ((isset($user->lang['TOTAL_POSTS'])) ? $user->lang['TOTAL_POSTS'] : '{ TOTAL_POSTS }')); ?>
                            :
                        </dt>
                        <dd><?php echo (isset($this->_rootref['POSTS'])) ? $this->_rootref['POSTS'] : ''; ?> <?php if ($this->_rootref['S_DISPLAY_SEARCH']) { ?>|
                                <strong><a
                                    href="<?php echo (isset($this->_rootref['U_SEARCH_USER'])) ? $this->_rootref['U_SEARCH_USER'] : ''; ?>"><?php echo((isset($this->_rootref['L_SEARCH_USER_POSTS'])) ? $this->_rootref['L_SEARCH_USER_POSTS'] : ((isset($user->lang['SEARCH_USER_POSTS'])) ? $user->lang['SEARCH_USER_POSTS'] : '{ SEARCH_USER_POSTS }')); ?></a>
                                </strong><?php }
                            if ($this->_rootref['POSTS_PCT']) { ?>
                                <br/>(<?php echo (isset($this->_rootref['POSTS_PCT'])) ? $this->_rootref['POSTS_PCT'] : ''; ?> / <?php echo (isset($this->_rootref['POSTS_DAY'])) ? $this->_rootref['POSTS_DAY'] : ''; ?>)<?php }
                            if ($this->_rootref['POSTS_IN_QUEUE'] && $this->_rootref['U_MCP_QUEUE']) { ?><br/>(<a
                                href="<?php echo (isset($this->_rootref['U_MCP_QUEUE'])) ? $this->_rootref['U_MCP_QUEUE'] : ''; ?>"><?php echo((isset($this->_rootref['L_POSTS_IN_QUEUE'])) ? $this->_rootref['L_POSTS_IN_QUEUE'] : ((isset($user->lang['POSTS_IN_QUEUE'])) ? $user->lang['POSTS_IN_QUEUE'] : '{ POSTS_IN_QUEUE }')); ?></a>)<?php } else if ($this->_rootref['POSTS_IN_QUEUE']) { ?>
                                <br/>(<?php echo((isset($this->_rootref['L_POSTS_IN_QUEUE'])) ? $this->_rootref['L_POSTS_IN_QUEUE'] : ((isset($user->lang['POSTS_IN_QUEUE'])) ? $user->lang['POSTS_IN_QUEUE'] : '{ POSTS_IN_QUEUE }')); ?>)<?php } ?>

                        </dd>
                        <?php if ($this->_rootref['S_SHOW_ACTIVITY'] && $this->_rootref['POSTS']) { ?>

                            <dt><?php echo((isset($this->_rootref['L_ACTIVE_IN_FORUM'])) ? $this->_rootref['L_ACTIVE_IN_FORUM'] : ((isset($user->lang['ACTIVE_IN_FORUM'])) ? $user->lang['ACTIVE_IN_FORUM'] : '{ ACTIVE_IN_FORUM }')); ?>
                                :
                            </dt>
                            <dd><?php if ($this->_rootref['ACTIVE_FORUM'] != ('')) { ?><strong><a
                                        href="<?php echo (isset($this->_rootref['U_ACTIVE_FORUM'])) ? $this->_rootref['U_ACTIVE_FORUM'] : ''; ?>"><?php echo (isset($this->_rootref['ACTIVE_FORUM'])) ? $this->_rootref['ACTIVE_FORUM'] : ''; ?></a>
                                    </strong>
                                    <br/>(<?php echo (isset($this->_rootref['ACTIVE_FORUM_POSTS'])) ? $this->_rootref['ACTIVE_FORUM_POSTS'] : ''; ?> / <?php echo (isset($this->_rootref['ACTIVE_FORUM_PCT'])) ? $this->_rootref['ACTIVE_FORUM_PCT'] : ''; ?>)<?php } else { ?> - <?php } ?>
                            </dd>
                            <dt><?php echo((isset($this->_rootref['L_ACTIVE_IN_TOPIC'])) ? $this->_rootref['L_ACTIVE_IN_TOPIC'] : ((isset($user->lang['ACTIVE_IN_TOPIC'])) ? $user->lang['ACTIVE_IN_TOPIC'] : '{ ACTIVE_IN_TOPIC }')); ?>
                                :
                            </dt>
                            <dd><?php if ($this->_rootref['ACTIVE_TOPIC'] != ('')) { ?><strong><a
                                        href="<?php echo (isset($this->_rootref['U_ACTIVE_TOPIC'])) ? $this->_rootref['U_ACTIVE_TOPIC'] : ''; ?>"><?php echo (isset($this->_rootref['ACTIVE_TOPIC'])) ? $this->_rootref['ACTIVE_TOPIC'] : ''; ?></a>
                                    </strong>
                                    <br/>(<?php echo (isset($this->_rootref['ACTIVE_TOPIC_POSTS'])) ? $this->_rootref['ACTIVE_TOPIC_POSTS'] : ''; ?> / <?php echo (isset($this->_rootref['ACTIVE_TOPIC_PCT'])) ? $this->_rootref['ACTIVE_TOPIC_PCT'] : ''; ?>)<?php } else { ?> - <?php } ?>
                            </dd>
                        <?php } ?>
        ...
        <?php if ($this->_rootref['SIGNATURE']) { ?>
            ...
            <div class="panel bg1">
                <div class="inner"><span class="corners-top"><span></span></span>
                    ...
                    <div class="postbody">
                        <div class="signature"
                             style="border-top:none; margin-top: 0;"><?php echo (isset($this->_rootref['SIGNATURE'])) ? $this->_rootref['SIGNATURE'] : ''; ?></div>
                    </div>
