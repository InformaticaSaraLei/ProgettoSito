...
<?php if ($this->_rootref['S_PRUNED']) { ?>
    ...
    <table cellspacing="1">
        ...
        <tbody>
        <?php $_pruned_count = (isset($this->_tpldata['pruned'])) ? sizeof($this->_tpldata['pruned']) : 0;
        if ($_pruned_count) {
            for ($_pruned_i = 0; $_pruned_i < $_pruned_count; ++$_pruned_i) {
                $_pruned_val = &$this->_tpldata['pruned'][$_pruned_i];
                if (!($_pruned_val['S_ROW_COUNT'] & 1)) { ?>
            ...
            <tr>
                <td colspan="3" class="row3"
                    style="text-align: center;"><?php echo((isset($this->_rootref['L_NO_PRUNE'])) ? $this->_rootref['L_NO_PRUNE'] : ((isset($user->lang['NO_PRUNE'])) ? $user->lang['NO_PRUNE'] : '{ NO_PRUNE }')); ?></td>
            </tr>
        <?php } ?>
        ...
        <fieldset>
            ...
            <dl>
                <dt><label
                        ...
                        :</label></dt>
                <dd><select id="forum" name="f[]" multiple="multiple"
            ...
            <p class="quick">
                <input class="button1" type="submit"
                       value="<?php echo((isset($this->_rootref['L_LOOK_UP_FORUM'])) ? $this->_rootref['L_LOOK_UP_FORUM'] : ((isset($user->lang['LOOK_UP_FORUM'])) ? $user->lang['LOOK_UP_FORUM'] : '{ LOOK_UP_FORUM }')); ?>"/>
            </p>
        </fieldset>
...
<?php } else { ?>
    ...
    <p><?php echo((isset($this->_rootref['L_SELECTED_FORUMS'])) ? $this->_rootref['L_SELECTED_FORUMS'] : ((isset($user->lang['SELECTED_FORUMS'])) ? $user->lang['SELECTED_FORUMS'] : '{ SELECTED_FORUMS }')); ?>
        : <?php echo (isset($this->_rootref['FORUM_LIST'])) ? $this->_rootref['FORUM_LIST'] : ''; ?></p>
    ...
    <form id="acp_prune" method="post"
        ...
        <fieldset>
            ...
            <dl>
                <dt><label
                        for="prune_days"><?php echo((isset($this->_rootref['L_PRUNE_NOT_POSTED'])) ? $this->_rootref['L_PRUNE_NOT_POSTED'] : ((isset($user->lang['PRUNE_NOT_POSTED'])) ? $user->lang['PRUNE_NOT_POSTED'] : '{ PRUNE_NOT_POSTED }')); ?>
                        :</label></dt>
                <dd><input type="text" id="prune_days" name="prune_days"/></dd>
            </dl>
            <dl>
                <dt><label
                        for="prune_vieweddays"><?php echo((isset($this->_rootref['L_PRUNE_NOT_VIEWED'])) ? $this->_rootref['L_PRUNE_NOT_VIEWED'] : ((isset($user->lang['PRUNE_NOT_VIEWED'])) ? $user->lang['PRUNE_NOT_VIEWED'] : '{ PRUNE_NOT_VIEWED }')); ?>
                        :</label></dt>
                <dd><input type="text" id="prune_vieweddays" name="prune_vieweddays"/></dd>
            </dl>
            <dl>
                <dt><label
                        for="polls"><?php echo((isset($this->_rootref['L_PRUNE_OLD_POLLS'])) ? $this->_rootref['L_PRUNE_OLD_POLLS'] : ((isset($user->lang['PRUNE_OLD_POLLS'])) ? $user->lang['PRUNE_OLD_POLLS'] : '{ PRUNE_OLD_POLLS }')); ?>
                ...
                <dd><label><input type="radio" class="radio" name="prune_old_polls"
                    ...
                    <label><input type="radio" class="radio" id="polls" name="prune_old_polls" value="0"
                                  checked="checked"/> <?php echo((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?>
                    </label></dd>
            </dl>
            <dl>
                <dt><label
                        for="announce"><?php echo((isset($this->_rootref['L_PRUNE_ANNOUNCEMENTS'])) ? $this->_rootref['L_PRUNE_ANNOUNCEMENTS'] : ((isset($user->lang['PRUNE_ANNOUNCEMENTS'])) ? $user->lang['PRUNE_ANNOUNCEMENTS'] : '{ PRUNE_ANNOUNCEMENTS }')); ?>
                        :</label></dt>
                <dd><label><input type="radio" class="radio" name="prune_announce"
                                  value="1"/> <?php echo((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?>
                    </label>
                    <label><input type="radio" class="radio" id="announce" name="prune_announce" value="0"
                                  checked="checked"/> <?php echo((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?>
                    </label></dd>
            </dl>
            <dl>
                <dt><label
                        for="sticky"><?php echo((isset($this->_rootref['L_PRUNE_STICKY'])) ? $this->_rootref['L_PRUNE_STICKY'] : ((isset($user->lang['PRUNE_STICKY'])) ? $user->lang['PRUNE_STICKY'] : '{ PRUNE_STICKY }')); ?>
                        :</label></dt>
                <dd><label><input type="radio" class="radio" name="prune_sticky"
                                  value="1"/> <?php echo((isset($this->_rootref['L_YES'])) ? $this->_rootref['L_YES'] : ((isset($user->lang['YES'])) ? $user->lang['YES'] : '{ YES }')); ?>
                    </label>
                    <label><input type="radio" class="radio" id="sticky" name="prune_sticky" value="0"
                                  checked="checked"/> <?php echo((isset($this->_rootref['L_NO'])) ? $this->_rootref['L_NO'] : ((isset($user->lang['NO'])) ? $user->lang['NO'] : '{ NO }')); ?>
                    </label></dd>
            </dl>
