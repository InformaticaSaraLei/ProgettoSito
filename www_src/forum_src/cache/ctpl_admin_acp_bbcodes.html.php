...
<?php if ($this->_rootref['S_EDIT_BBCODE']) { ?>
    ...
    <form id="acp_bbcodes" method="post"
        ...
        <fieldset>
            ...
            <dl>
                <dt><label
                        for="bbcode_match"><?php echo((isset($this->_rootref['L_EXAMPLES'])) ? $this->_rootref['L_EXAMPLES'] : ((isset($user->lang['EXAMPLES'])) ? $user->lang['EXAMPLES'] : '{ EXAMPLES }')); ?></label><br/><br/><span><?php echo((isset($this->_rootref['L_BBCODE_USAGE_EXAMPLE'])) ? $this->_rootref['L_BBCODE_USAGE_EXAMPLE'] : ((isset($user->lang['BBCODE_USAGE_EXAMPLE'])) ? $user->lang['BBCODE_USAGE_EXAMPLE'] : '{ BBCODE_USAGE_EXAMPLE }')); ?></span>
                </dt>
                <dd><textarea id="bbcode_match" name="bbcode_match" cols="60"
                              rows="5"><?php echo (isset($this->_rootref['BBCODE_MATCH'])) ? $this->_rootref['BBCODE_MATCH'] : ''; ?></textarea>
                </dd>
            </dl>
        </fieldset>
        ...
        <fieldset>
            ...
            <dl>
                <dt><label
                        for="bbcode_tpl"><?php echo((isset($this->_rootref['L_EXAMPLES'])) ? $this->_rootref['L_EXAMPLES'] : ((isset($user->lang['EXAMPLES'])) ? $user->lang['EXAMPLES'] : '{ EXAMPLES }')); ?></label><br/><br/><span><?php echo((isset($this->_rootref['L_HTML_REPLACEMENT_EXAMPLE'])) ? $this->_rootref['L_HTML_REPLACEMENT_EXAMPLE'] : ((isset($user->lang['HTML_REPLACEMENT_EXAMPLE'])) ? $user->lang['HTML_REPLACEMENT_EXAMPLE'] : '{ HTML_REPLACEMENT_EXAMPLE }')); ?></span>
                </dt>
                <dd><textarea id="bbcode_tpl" name="bbcode_tpl" cols="60"
                              rows="8"><?php echo (isset($this->_rootref['BBCODE_TPL'])) ? $this->_rootref['BBCODE_TPL'] : ''; ?></textarea>
                </dd>
            </dl>
        </fieldset>
        ...
        <fieldset>
            ...
            <dl>
                <dt><label
                        for="bbcode_helpline"><?php echo((isset($this->_rootref['L_BBCODE_HELPLINE_TEXT'])) ? $this->_rootref['L_BBCODE_HELPLINE_TEXT'] : ((isset($user->lang['BBCODE_HELPLINE_TEXT'])) ? $user->lang['BBCODE_HELPLINE_TEXT'] : '{ BBCODE_HELPLINE_TEXT }')); ?></label>
                </dt>
                <dd><input type="text" id="bbcode_helpline" name="bbcode_helpline" size="60" maxlength="255"
                           value="<?php echo (isset($this->_rootref['BBCODE_HELPLINE'])) ? $this->_rootref['BBCODE_HELPLINE'] : ''; ?>"/>
                </dd>
            </dl>
        </fieldset>
        ...
        <fieldset>
            ...
            <dl>
                <dt><label
                        for="display_on_posting"><?php echo((isset($this->_rootref['L_DISPLAY_ON_POSTING'])) ? $this->_rootref['L_DISPLAY_ON_POSTING'] : ((isset($user->lang['DISPLAY_ON_POSTING'])) ? $user->lang['DISPLAY_ON_POSTING'] : '{ DISPLAY_ON_POSTING }')); ?></label>
                </dt>
                <dd><input type="checkbox" class="radio" name="display_on_posting" id="display_on_posting"
                           value="1"<?php if ($this->_rootref['DISPLAY_ON_POSTING']) { ?> checked="checked"<?php } ?> />
                </dd>
            </dl>
        </fieldset>
        ...
        <table cellspacing="1" id="down">
            ...
            <tr>
                <td class="row3"
                    colspan="2"><?php echo((isset($this->_rootref['L_TOKENS_EXPLAIN'])) ? $this->_rootref['L_TOKENS_EXPLAIN'] : ((isset($user->lang['TOKENS_EXPLAIN'])) ? $user->lang['TOKENS_EXPLAIN'] : '{ TOKENS_EXPLAIN }')); ?></td>
            </tr>
            <tr>
            ...
            <tbody>
            <?php $_token_count = (isset($this->_tpldata['token'])) ? sizeof($this->_tpldata['token']) : 0;
            if ($_token_count) {
                for ($_token_i = 0; $_token_i < $_token_count; ++$_token_i) {
                    $_token_val = &$this->_tpldata['token'][$_token_i]; ?>
    ...
    <form id="acp_bbcodes" method="post"
        ...
        <fieldset class="tabulated">
            ...
            <table cellspacing="1" id="down">
                ...
                <tbody>
                <?php $_bbcodes_count = (isset($this->_tpldata['bbcodes'])) ? sizeof($this->_tpldata['bbcodes']) : 0;
                if ($_bbcodes_count) {
                    for ($_bbcodes_i = 0; $_bbcodes_i < $_bbcodes_count; ++$_bbcodes_i) {
                        $_bbcodes_val = &$this->_tpldata['bbcodes'][$_bbcodes_i];
                        if (!($_bbcodes_val['S_ROW_COUNT'] & 1)) { ?>
                            <tr class="row1"><?php } else { ?><tr class="row2"><?php } ?>

                        <td style="text-align: center;"><?php echo $_bbcodes_val['BBCODE_TAG']; ?></td>
                        <td style="text-align: right; width: 40px;"><a
                                href="<?php echo $_bbcodes_val['U_EDIT']; ?>"><?php echo (isset($this->_rootref['ICON_EDIT'])) ? $this->_rootref['ICON_EDIT'] : ''; ?></a>
                            <a href="<?php echo $_bbcodes_val['U_DELETE']; ?>"><?php echo (isset($this->_rootref['ICON_DELETE'])) ? $this->_rootref['ICON_DELETE'] : ''; ?></a>
                        </td>
                        </tr>
                    <?php }
                } else { ?>
            ...
            <p class="quick">
                <input class="button2" name="submit" type="submit"
                       value="<?php echo((isset($this->_rootref['L_ADD_BBCODE'])) ? $this->_rootref['L_ADD_BBCODE'] : ((isset($user->lang['ADD_BBCODE'])) ? $user->lang['ADD_BBCODE'] : '{ ADD_BBCODE }')); ?>"/>
            </p>
            <?php echo (isset($this->_rootref['S_FORM_TOKEN'])) ? $this->_rootref['S_FORM_TOKEN'] : ''; ?>
