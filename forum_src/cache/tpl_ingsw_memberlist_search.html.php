...
<?php } ?>
	...
	<dl>
		<dt><label for="jabber"><?php echo ((isset($this->_rootref['L_JABBER'])) ? $this->_rootref['L_JABBER'] : ((isset($user->lang['JABBER'])) ? $user->lang['JABBER'] : '{ JABBER }')); ?>:</label></dt>
		<dd><input type="text" name="jabber" id="jabber" value="<?php echo (isset($this->_rootref['JABBER'])) ? $this->_rootref['JABBER'] : ''; ?>" class="inputbox" /></dd>
	</dl>
	</fieldset>
